const Header = () => {
    return (
        <header className="relative flex items-center justify-between px-8 py-5 bg-gradient-to-r from-[#000000] to-[#b8a5e5] z-10">
            ...
            <div className="flex items-center relative">
                ...
                <span className="font-bold text-white text-xl tracking-tight">Insite Wear- AI</span>
            </div>
